...
(function () {
  ...
  function init() {
    ...
    (function(){
      ...
      function scanTips(){ const tips=parseTips(); Object.keys(tips).forEach(d=>{ const t=tips[d]&&tips[d].timestamp||''; const prev=seenTips.get(d)||''; if(t&&t!==prev){ seenTips.set(d,t); Promise.resolve().then(()=>upsertTip(d,tips[d])); } }); }
